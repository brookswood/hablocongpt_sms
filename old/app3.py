...
sherlock_phone_number = os.environ.get('SONIA_PHONE_NUMBER')
...
# def sms_reply():
    ...
    if user is None:
        ...
        if stage == 'name':
            ...
            resp.message("Please respond with 'yes' or 'agree'. By continuing to send messages to this service, you are agreeing to Our Terms of Service. https://beta.convowithgpt.com/terms-of-service/ and Privacy Policy https://beta.convowithgpt.com/privacy-policy/")
        elif stage == 'agree':
